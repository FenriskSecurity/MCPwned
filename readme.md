...
Whenever you encounter an MCP-like endpoint the extension will color it in grey. From there you can send the request to the extension with a right-click or a `Ctrl + M` shortcut.
